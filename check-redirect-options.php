...
function eg_settings_api_init() {
    ...
    add_settings_section(
        ...
        'check-redirect/check-redirect-options.php' // страница
    );
    ...
    add_settings_field(
        ...
        'check-redirect-options', // страница
        'eg_setting_section' // секция
    );
    add_settings_field(
        'eg_setting_name2',
    ...
    register_setting( 'check-redirect', 'eg_setting_name' );
    register_setting( 'check-redirect', 'eg_setting_name2' );
}
